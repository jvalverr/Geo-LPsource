...
#ifndef NEARBYDISTANCEALLOCATIONLP_H_INCLUDED
#define NEARBYDISTANCEALLOCATIONLP_H_INCLUDED


#include "../Network.h"
#include "LinkPredictor.h"

class NearbyDistanceAllocationLP : public LinkPredictor {
	private:
	protected:
	public:
		NearbyDistanceAllocationLP( const Network& );
		~NearbyDistanceAllocationLP();
		virtual double generateScore( index_v, index_v );
};


#endif // NEARBYDISTANCEALLOCATIONLP_H_INCLUDED
