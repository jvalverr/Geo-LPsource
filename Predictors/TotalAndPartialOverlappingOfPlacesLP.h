...
#ifndef TOTALANDPARTIALOVERLAPPINGOFPLACESLP_H_INCLUDED
#define TOTALANDPARTIALOVERLAPPINGOFPLACESLP_H_INCLUDED

#include "../Network.h"
#include "LinkPredictor.h"

class TotalAndPartialOverlappingOfPlacesLP : public LinkPredictor {
	private:
	protected:
	public:
		TotalAndPartialOverlappingOfPlacesLP( const Network& );
		~TotalAndPartialOverlappingOfPlacesLP();
		double generateScore( index_v, index_v );
};


#endif // TOTALANDPARTIALOVERLAPPINGOFPLACESLP_H_INCLUDED
