...
#ifndef CHECKINOBSERVATIONLP_H_INCLUDED
#define CHECKINOBSERVATIONLP_H_INCLUDED

#include "../Network.h"
#include "LinkPredictor.h"

class CheckInObservationLP : public LinkPredictor {
	private:
	protected:
	public:
		 CheckInObservationLP( const Network& );
		~CheckInObservationLP();
		virtual double generateScore( index_v, index_v );
};


#endif // CHECKINOBSERVATIONLP_H_INCLUDED
