...
#ifndef CHECKINALLOCATIONLP_H_INCLUDED
#define CHECKINALLOCATIONLP_H_INCLUDED


#include "../Network.h"
#include "LinkPredictor.h"

class CheckInAllocationLP : public LinkPredictor {
	private:
	protected:
	public:
		CheckInAllocationLP( const Network& );
		~CheckInAllocationLP();
		virtual double generateScore( index_v, index_v );
};


#endif // CHECKINALLOCATIONLP_H_INCLUDED
